          ...
          <Link to={"/profile"}>
            {currentUser ? (
              <img
                ...
                alt="Profile"
                className="border-black border w-10 object-cover h-10 rounded-full"
              />
            ) : (
              <li className="text-white bg-[#0f0f0f] rounded-md p-2 font-lexend flex items-center justify-center">
                Sign In
              </li>
            )}
          </Link>
