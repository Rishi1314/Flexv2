...
function Profile() {
  ...
  const tagColors = {
    AIAficionado: "424769",
    CompetitiveCoder: "005B41",
    FullStackMagician: "7D7C7C",
    PythonPro: "FFE382",
    UIUXUnicorn: "711DB0",
    AppDeveloper: "0079FF",
    WebDeveloper: "00A9FF",
    Creator: "FD8D14",
    ReactRockstar: "82CD47",
  };
    ...
    >
      <div className="flex max-[767px]:flex-col gap-2 w-[100%]">
        <div className="group before:hover:scale-95 before:hover:w-[99%] before:hover:h-[350px] before:hover:rounded-b-2xl before:transition-all before:duration-500 before:content-[''] before:w-[100%] before:h-24 before:rounded-t-2xl before:bg-gradient-to-bl from-sky-200 via-orange-200 to-orange-700 before:absolute before:top-0  h-[350px] relative bg-[#1E1F24] flex items-center justify-center flex-col rounded-[30px] overflow-hidden w-[30%]  max-[767px]:w-[100%]">
          <div className="w-28 h-28 bg-blue-700 mt-8 rounded-full border-4 border-slate-50 z-10 group-hover:scale-60 group-hover:-translate-x-0  group-hover:-translate-y-10 transition-all duration-500">
            <img
              src={currentUser.profilePicture}
              className="  border-[2px] w-[8rem] rounded-full aspect-square object-cover"
              alt=""
            />
          </div>

          <div className="z-10 w-[90%] group-hover:-translate-y-10 transition-all flex flex-col gap-2 items-center duration-500">
            <span className="flex items-center text-white text-2xl font-lexend gap-1">
              {currentUser.username}

              <Link to={"/editprofile"}>
                <div className="bg-[#e2e2e2] p-1 text-black rounded-full text-sm">
                  {" "}
                  <BsFillPencilFill />
                </div>
              </Link>
            </span>
            <div className="flex justify-evenly text-white w-[50%]">
              <span className="max-[767px]:text-[100%] text-xl">
                {currentUser.firstName}
              </span>
              <span className="text-xl max-[767px]:text-[100%] ">
        ...
        <div className="shadow-lg ring-1 ring-white/5 p-4 rounded-[30px] bg-[#1E1F24] flex-col max-[767px]:w-[100%] flex h-[350px]  w-[70%] gap-2  ">
          <div className=" max-[767px]: projectsCardProfile p-2 flex gap-2 w-[100%] h-[350px] overflow-x-auto overflow-y-hidden">
            ...
            {projects.length > 0 ? (
                ...
                return (
                  ...
                  >
                    <img
                      ...
                      alt="Project Picture"
                      className="w-[250px] h-[200px] object-cover border border-dashed border-black rounded-md"
                    />
              ...
              <div className="text-white font-lexend flex justify-center items-center w-[100%] h-[100%]">
                Your Projects would have been displayed here if you hand any!
              </div>
            )}
          </div>
        </div>
      ...
      <div className="shadow-lg ring-1 ring-white/5 p-4 w-[100%] rounded-[30px] bg-[#1E1F24]">
        <div className=" max-[767px]:justify-center max-[767px]:w-[100%] w-[50%] flex flex-wrap gap-2">
          {currentUser.tags.map((tag) => {
            ...
            return (
              <span
                style={{ backgroundColor: `#${tagColors[tagCol]}` }}
