      ...
      <div className="w-[100%]">
        ...
        >
          <form
            ...
            className={`text-white dashboardChildChild   h-[300px] flex flex-col items-center rounded-[10px] p-4 gap-4 overflow-y-scroll`}
          >
            ...
            tasks.map((task) => {
              ...
              return (
                <div
                  className={`${
                    what ? "bg-red-400" : ""
                  }  projectCard flex p-2 gap-2 flex-col items-center w-[400px] h-[300px] rounded-xl `}
                  key={task.id}
                >
                  <div className="w-[70%] flex items-center  justify-between  text-white">
                    <span className="font-lexend  text-[120%] w-[50%] overflow-hidden  ">
                      {task.taskName}
                    </span>
                    <span
                      className={`${
