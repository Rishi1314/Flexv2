...
export default function EditProject() {
    ...
    bg-[#1E1F24] w-[100%] flex flex-col  p-5 gap-2'>
            ...
            <div className='bg-[#141619] p-6 h-[90vh] rounded-2xl'>
                ...
                <form onSubmit={handleSubmit} className='flex max-[767px]:flex-col max-[767px]:gap-1 gap-4 '>
                    <div className='flex min-[768px]:bg-[#24252a8c] rounded-2xl flex-col w-1/2 max-[767px]:items-center max-[767px]:w-[100%] gap-2
                    justify-center items-center '>
                        <div className='flex max-[767px]:flex-col gap-2 items-center'>
                            ...
                            <img
                                ...
                                cursor-pointer rounded-md object-cover mt-2 '
                    ...
                    <div className='w-[100%] flex items-center gap-2 flex-col'>
